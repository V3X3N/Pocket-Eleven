...
import 'package:pocket_eleven/pages/club/bloc/stadium_bloc.dart';

class ClubStadiumPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => StadiumBloc()..add(LoadStadiumDataEvent()),
      child: Scaffold(
              ...
              child: Container(
                decoration: const BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage('assets/background/club_stadion.png'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
          ...
          children: [
            ElevatedButton(
              onPressed: canUpgrade
                  ? () {
                      context.read<StadiumBloc>().add(UpgradeStadiumEvent());
                      onCurrencyChange();
                    }
                  : null,
